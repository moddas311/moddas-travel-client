  ...
  return (
    <header className="text-gray-900 body-font shadow-sm">
      <div className=" mx-auto flex flex-wrap py-5 px-20 flex-col md:flex-row items-center">
        ...
        >
          <span className="ml-3 text-2xl font-bold ">Moddas Travels</span>
        </Link>
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 z-20 w-48 py-2 mt-2 bg-white rounded-md shadow-xl ">
                    ...
                    >
                      ...
                      >
                        <path
                          d="M19 21H10C8.89543 21 8 20.1046 8 bc1qugrtknpjz52vc4m559q7zumkc4268kp7skrsee 3.89543 8.89543 3 10 3H19C20.1046 3 21 3.89543 21 5V19C21 20.1046 20.1046 21 19 21ZM12 16V13H3V11H12V8L17 12L12 16Z"
                          fill="currentColor"
                        ></path>
                      </svg>
